...
#include "../files.h"
#include "../HashTable.h"
#include "../os_windows/threading.h"

#ifdef USE_FREETYPE
#define FONT_INCLUDE "../load_font_ft2.h"
#else
#define FONT_INCLUDE "../load_font.h"
#endif
...
int main( void ) {
	...
	while (TodoApp.running) {		
		...
		ui_input Input = UI_LastEvent(TodoApp.UI_Context, &TodoApp.VkBase.Window);
